            ...
            <Container>
                <Row>
                    ...
                    <div className='textHome'>
                        - If you want to send transactions in Arbitrum, zkSync, BSC - you need certain provider for certain chain. By default site works in Goerli.<br></br>
                        - You need to be attentive when you send uint256 arguments to the Smart Contract. You must consider decimals of this args.<br></br>
